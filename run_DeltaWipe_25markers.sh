...
for SEED in 0 1 2 3 
do
    run_train $TASK "SAC" 3_500_000 "TRUE" "TRUE" "FULL_GRL_NOTCONDENSED_25_MARKERS" $SEED 
    run_train $TASK "SAC" 3_500_000 "TRUE" "FALSE" "SPD_ONLY_NOTCONDENSED_25_MARKERS" $SEED 
    run_train $TASK "SAC" 3_500_000 "FALSE" "TRUE" "LIE_ONLY_NOTCONDENSED_25_MARKERS" $SEED 
    run_train $TASK "SAC" 3_500_000 "FALSE" "FALSE" "BASELINE_NOTCONDENSED_25_MARKERS" $SEED 
done

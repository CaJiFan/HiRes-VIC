...
matrix (parameterized on the Sym+(3) manifold), and orientation is controlled via SO(3) \
error. Your job: given the current task state, select the optimal impedance mode.

Available modes: approach, contact_edge, wipe_x, wipe_y, retract
